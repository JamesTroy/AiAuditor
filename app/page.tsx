      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12 relative">
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            <Logo size={48} />
            <h1 className="text-[clamp(1.875rem,4vw+0.5rem,3.5rem)] font-bold tracking-tight dark:text-gradient">Claudit</h1>
          </div>
        ...
        {/* How it works */}
        <div className="mb-10 max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-center">
