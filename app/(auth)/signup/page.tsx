    ...
    return (
      <div className="bg-white/90 dark:bg-zinc-900/70 backdrop-blur-sm border border-gray-200 dark:border-zinc-800 rounded-2xl p-8 shadow-sm motion-safe:animate-fade-up text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-zinc-400 mb-6">
          We sent a verification link to <strong className="text-gray-700 dark:text-zinc-300">{email}</strong>. Click the link to activate your account and start auditing.
        </p>
        <p className="text-xs text-gray-400 dark:text-zinc-600">
          Didn&apos;t receive it? Check your spam folder or{' '}
          <button
            onClick={() => setVerificationSent(false)}
            className="text-violet-600 dark:text-violet-400 hover:text-violet-500 underline underline-offset-2"
          >
