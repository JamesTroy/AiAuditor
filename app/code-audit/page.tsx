      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 dark:text-zinc-400 text-base sm:text-lg max-w-2xl mx-auto">
            Paste any code — get a severity-rated report from {allAgents.length}+ specialized
            auditors covering security, performance, accessibility, SQL, API design, and more.
            Results stream in real time.
          </p>
          <p className="text-xs text-gray-400 dark:text-zinc-600 mt-2">
            Auditing a live site?{' '}
            <Link href="/site-audit" className="underline underline-offset-2 hover:text-violet-500 transition-colors">
              Use the Site Audit tool instead →
            </Link>
          </p>
        </div>
                ...
                {!session && (
                  <div className="mb-4 p-4 rounded-xl bg-violet-50 dark:bg-violet-950/30 border border-violet-200 dark:border-violet-800 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href="/signup?callbackUrl=/code-audit" className="inline-block mt-2 text-xs font-semibold text-violet-600 dark:text-violet-300 hover:text-violet-500 underline underline-offset-2">Create free account →</a>
                    </div>
                  </div>
                )}
                {session && (
