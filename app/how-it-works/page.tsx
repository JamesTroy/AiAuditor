...
function StepCard({ step, title, description }: { step: number; title: string; description: string }) {
  return (
    <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl p-5 relative hover:shadow-md hover:border-violet-500/20 transition-[box-shadow,border-color] motion-safe:animate-fade-up" style={{ animationDelay: `${(step - 1) * 100}ms`, animationFillMode: 'both' }}>
...
function FeatureRow({ title, items }: { title: string; items: string[] }) {
  return (
    <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl p-5 hover:shadow-md hover:border-violet-500/20 transition-[box-shadow,border-color]">
