        ...
        <div className="flex items-start justify-between mb-6 gap-4 flex-wrap">
          <div>
            ...
            <p className="text-gray-500 dark:text-zinc-500 text-sm">
              {entries.length} audit{entries.length !== 1 ? 's' : ''} stored in your browser&apos;s localStorage. Results are generated by Claude Sonnet 4.6 and kept client-side — nothing is sent to our servers.
            </p>
          </div>
          {entries.length > 0 && (
            <button
