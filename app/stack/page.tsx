        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <StackCard
              ...
              description="Claude Sonnet 4.6 via the Anthropic SDK. Each of the 50 audit agents has a specialized system prompt with structured output, severity ratings, and scoring."
              color="violet"
            />
            <StackCard
              layer="Styling"
