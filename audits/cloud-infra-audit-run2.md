...
| 5 | **CLOUD-017** — In-memory rate limiting ineffective across replicas | Confirm all rate-limited endpoints use Upstash Redis; add `UPSTASH_REDIS_REST_URL/TOKEN` to env and `.env.example` | 4