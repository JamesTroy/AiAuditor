    ...
    <section className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl p-6 mb-6">
      ...
      {step === 'loading' && (
        <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-zinc-400">
          <svg className="w-4 h-4 motion-safe:animate-spin text-violet-500" viewBox="0 0 24 24" fill="none" aria-hidden="true"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" /><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" /></svg>
          Setting up...
        </div>
      )}
