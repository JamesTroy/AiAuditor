    ...
    <section id="pricing" className="py-28 border-b border-zinc-800/60">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, scale: 1, y: 0, transition: transitions.springGentle }}
          viewport={inView}
        ...
        >
          <div className="relative rounded-2xl bg-violet-600 border border-violet-500 shadow-2xl shadow-violet-900/30 p-8 text-center">
            ...
            <motion.ul
              ...
              whileInView="visible"
              viewport={inView}
              className="space-y-2.5 mb-8 text-left"
            >
              {[
                'All 193 specialized auditors',
                'Unlimited audits',
                ...
                <motion.li key={f} variants={fadeUp} className="flex items-center gap-2.5 text-sm text-violet-100">
...
export function CtaSection() {
  return (
    <section className="py-28">
      ...
      >
        <motion.h2 variants={fadeUp} className="text-5xl font-bold text-white tracking-tight mb-5">
          Ship code you&apos;re proud of
        </motion.h2>
        <motion.p variants={fadeUp} className="text-lg text-zinc-400 font-light mb-10">
          193 AI auditors. Severity rankings. Exact fix guidance. Under 60 seconds.
        </motion.p>
        <motion.div variants={fadeUp} className="flex items-center justify-center gap-3 flex-wrap mb-5">
        ...
        <motion.p variants={fadeUp} className="text-xs text-zinc-600">
          No credit card &middot; free during early access &middot; no limits
        </motion.p>
      </motion.div>
    </section>
  );
